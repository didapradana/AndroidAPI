...
public class ChannelFragment extends Fragment {
    ...
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyA3f0Qhr1hQAASZSEvrRlLO62mEzSJBHGI";//here you should use your api key for testing purpose you can use this api also
    private static String CHANNEL_ID = "UCmMeumAq7JlVHlL7-4MUIAQ"; //here you should use your channel id for testing purpose you can use this ID also
